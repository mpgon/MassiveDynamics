...
//     struct BasicHttpBinding_IMassiveDynamicsWServiceFunctionTable

// the following policy helpers were generated:

//  BasicHttpBinding_IMassiveDynamicsWService_CreateServiceProxy;
//  BasicHttpBinding_IMassiveDynamicsWService_CreateServiceEndpoint;
...
typedef HRESULT (CALLBACK* BasicHttpBinding_IMassiveDynamicsWService_authenticateCallback) (
    _In_ const WS_OPERATION_CONTEXT* _context,
    _In_opt_z_ WCHAR* user, 
    _In_opt_z_ WCHAR* pass, 
    _Out_ BOOL* authenticateResult, 
...
typedef struct _tempuri_org_wsdl
{
    struct // messages
    {
        // message: IMassiveDynamicsWService_authenticate_InputMessage
        // c type: _authenticate
        // action: "http://tempuri.org/IMassiveDynamicsWService/authenticate"
        // messageDescription: tempuri_org_wsdl.messages.IMassiveDynamicsWService_authenticate_InputMessage
        WS_MESSAGE_DESCRIPTION IMassiveDynamicsWService_authenticate_InputMessage;
        
        // message: IMassiveDynamicsWService_authenticate_OutputMessage
        // c type: _authenticateResponse
        // action: "http://tempuri.org/IMassiveDynamicsWService/authenticateResponse"
    ...
    {
        // binding: BasicHttpBinding_IMassiveDynamicsWService
        // portType: IMassiveDynamicsWService
        // operation: BasicHttpBinding_IMassiveDynamicsWService_authenticate
    ...
    struct // policies
    {
        // policy for binding: BasicHttpBinding_IMassiveDynamicsWService
        // port name: BasicHttpBinding_IMassiveDynamicsWService, binding: BasicHttpBinding_IMassiveDynamicsWService, namespace: http://tempuri.org/
        WS_HTTP_POLICY_DESCRIPTION BasicHttpBinding_IMassiveDynamicsWService;
    } policies;
} _tempuri_org_wsdl;
